...
const RegisterForm = props => {
  ...
  const handleSubmit = e => {
    ...
    if (
      ...
      console.log("smosss");
      setErrorMessage({
        name: !e.target.elements[0].value && "Name can't be empty",
        email: !e.target.elements[1].value
          ? "Email can't be empty"
          : !validateEmail(email)
          ? "Email is not valid"
          : null,
        password: !e.target.elements[2].value && "Password can't be empty"
      });
    ...
    axios({
      ...
      .catch(err => {
        ...
        err.response.status === 400 &&
          setErrorMessage({ all: err.response.data });
      });
  };
  return (
    <div className="registrationForm">
      {registrationCompleted ? (
        <h3 style={{ marginTop: 50, width: 360 }}>
        ...
        <form id="register" onSubmit={handleSubmit}>
          <InputElement
            ...
            onChange={e => {
              ...
              setErrorMessage(Object.assign({}, errorMessage, { name: null }));
            }}
          />
          <InputElement
      ...
      <p className="registrationForm_BottomText">
