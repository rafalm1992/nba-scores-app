    ...
    return (
        <div className="loginForm">
            <form id="login" onSubmit={handleSubmit}>
                <InputElement errorMessage={errorMessage.email} type="text" icon={'email'} placeholder="Email" value={email} onChange={(e)=>{setEmail(e.target.value); setErrorMessage(Object.assign({},errorMessage,{email: null}))}}/>
                <InputElement errorMessage={errorMessage.password}  type="password" icon={'password'} placeholder="Password" value={password} onChange={(e)=>{setPassword(e.target.value); ; setErrorMessage(Object.assign({},errorMessage,{password: null}))}}/>
            ...
            <p className="loginForm__BottomText"><span onClick={()=>{props.changeComponent('register')}}>Register</span><span onClick={()=>{props.changeComponent('forgotten')}}>Forgotten password</span></p>
        </div>
    )
}
