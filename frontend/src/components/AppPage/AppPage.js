  ...
  useEffect(() => {
    ...
    var downloadTimer = setInterval(function() {
      document.getElementById(
        "countdown"
      ).innerHTML = timeleft.toString().toHHMMSS();
      timeleft -= 1;
      if (timeleft <= 0) {
      ...
      <nav className="appPage__NavigationContainer">
        ...
        <div className="appPage__NavigationList">
          <span
            ...
            className={activeComponent === "scores" && "active"}
          >
            Scores{" "}
          </span>{" "}
          /{" "}
          <span
            data-name="standings"
            onClick={changeComponent}
            className={activeComponent === "standings" && "active"}
          >
            {" "}
            Standings{" "}
          </span>{" "}
          ...
          <span
            data-name="top10"
            onClick={changeComponent}
            className={activeComponent === "top10" && "active"}
          >
            Top10
          </span>
        </div>
